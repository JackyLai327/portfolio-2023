    ...
    return (
        <>
            <div className="nav-bar" onMouseLeave={handleNavClose}>
                ...
                <div className={navOpen === true ? "nav-bar-item contact-pushed" : "nav-bar-item contact-back"}><a className = {location === "/portfolio-2023/contact" ? "user-location" : ''} href="/contact">Contact</a></div>
            </div>
