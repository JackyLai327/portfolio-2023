    ...
    return (
        <>
            <div className="nav-bar" onMouseLeave={handleNavClose}>
                ...
                <div className={location === "/education" || location === "/experience" || location === "/portfolio-2023/projects" ? "nav-bar-item about-btn user-location" : "nav-bar-item about-btn"} onMouseEnter={handleNavOpen}>About</div>
